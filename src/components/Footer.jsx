...
const Footer = () => (
  <section className={'flex justify-center items-center sm:py-16 py-6 flex-col'}>
    <div className={'flex justify-center items-start md: flex-row flex-col mb-8 w-full'}>
      ...
      <div className="flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-10 mt-20">
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px]  border-t-[#3F3E45]">
      <p className="font-poppins font-normal tex-center font-[18px] leading-[27px] text-white">2021 HooBank. All Rights Reserved.</p>
